...
- `Готово` — процент подтверждённых workunit'ов с canonical result;
...
- `Полезная нагрузка` — доля времени canonical result относительно всех завершённых attempts; лишние реплики не считаются полезными;
